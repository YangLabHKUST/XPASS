...
where z is the z-score of external summsry statistics, n is its sample size, <img src="https://render.githubusercontent.com/render/math?math=\mu"> is the posterior mean of effect size at the standardized genotype scale, $\Sigma$ is the LD reference panel.
